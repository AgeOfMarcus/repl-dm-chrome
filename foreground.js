                    ...
                    msgsDiv.append($(`
                        ...
                        <label class='node' for='msg-${_msg_node_increment}'>
                            ...
                            <div class='mid' status='${((recent.from == user) ? 'received' : 'sent')}'> 
                                <div class='name'>${user} ${['rafrafraf', 'MarcusWeinberger'].includes(recent.from) ? "<div class='badge' style='position: absolute; right: -2px; transform: translate(100%, -10%);'><img src='https://i.imgur.com/6D1IhQM.png' /></div>" : ''}</div>
